    ...
    var course = {
        ...
        init : function(){
            ...
            for(var i=0; i<3; i++){
                ...
                value2.setClass('course_value');
                ul.appendChild(value2);
                
                item['value2_dom_obj'] = value2;
        ...
        set : function(data){
            ...
            for(var i=0; i<this.map.length; i++){
                ...
                if (data['data'].hasOwnProperty(i)){
                    ...
                    this.map[i].value2_dom_obj.innerHTML    = data['data'][i].value2;
                    ...
                    this.map[i].value2_dom_obj.innerHTML    = '';					
                    this.map[i].trend_val.innerHTML = '';
                    this.map[i].darr.hide();
                    this.map[i].uarr.hide();
                }
